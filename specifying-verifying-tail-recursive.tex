...
\lstinputlisting[firstline=18, lastline=40]{code/Rev.agda}
...
\lstinputlisting[firstline=22, lastline=24]{code/GenericBasic.agda}
...
\lstinputlisting[firstline=26, lastline=28]{code/GenericBasic.agda}
...
\lstinputlisting[firstline=50, lastline=57]{code/GenericBasic.agda}
...
\lstinputlisting[firstline=38, lastline=41]{code/GenericBasic.agda}
...
\lstinputlisting[firstline=42, lastline=44]{code/GenericBasic.agda}
...
\lstinputlisting[firstline=45, lastline=48]{code/GenericBasic.agda}

Finally, we just need to prove the generalized accumulation pulling function, which has
the following type signature:

\lstinputlisting[firstline=30, lastline=32]{code/GenericBasic.agda}
...
\lstinputlisting[firstline=33, lastline=36]{code/GenericBasic.agda}
...
\lstinputlisting[firstline=5, lastline=20]{code/GenericBasic.agda}
...
\lstinputlisting[firstline=34, lastline=46]{code/Instances.agda}
...
\lstinputlisting[firstline=78, lastline=86]{code/Instances.agda}
...
This is the entire Agda source code for the relevant modules. If you have no prior
experience with Agda, you can check out the following resources for a getting started
guide:
\url{https://agda.readthedocs.io/en/v2.6.2.1/getting-started/what-is-agda.html}
and \url{https://plfa.github.io/GettingStarted/}. All these modules must be placed in the
same directory.

\subsection{Length.agda}
\lstinputlisting[]{code/Length.agda}

\subsection{Rev.agda}
\lstinputlisting[]{code/Rev.agda}

\subsection{GenericBasic.agda}
\lstinputlisting[]{code/GenericBasic.agda}

\subsection{Instances.agda}
\lstinputlisting[]{code/Instances.agda}
